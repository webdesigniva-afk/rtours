...
values
  ...
  ('collection', 'red-signature', 'Red Signature', 'Red Signature', '#b52b26', 'sparkles', 10),
  ('collection', 'red-escape', 'Red Escape', 'Red Escape', '#2657b8', 'plane', 20),
  ('collection', 'red-moments', 'Red Moments', 'Red Moments', '#7c4fd4', 'heart', 30),
